...
publicWidget.registry.AttendancePortal = publicWidget.Widget.extend({
    ...
    async _loadPage(page = 1, append = false, filters = {}) {
        ...
        try {
            const result = await rpc(`/my/attendance/json`, {start_day:dateStart, end_day:dateEnd,page, page_size: pageSize,filters, });
            //console.log(result);
    ...
    async _onGetPunches(ev) {
        ...
        this.dialog.add(ConfirmationDialog, {
            ...
            confirm: async () => {
                ...
                try {
                        const result = await rpc("/my/attendance/get_punches", payload);
